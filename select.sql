...
-- 3) first_name이 Shanta보다 뒤
SELECT employee_id, first_name, last_name FROM employees
WHERE first_name > 'Shanta';

-- 4) first_name 첫 글자가 J보다 뒤
SELECT employee_id, first_name, last_name FROM employees
WHERE first_name > 'J';
...
/*  LIKE  */
-- 1) first_name이 G_ra_d
SELECT employee_id, first_name, last_name FROM employees
WHERE first_name LIKE 'G_ra_d'; -- _는 한글자를 의미

-- 2) K로 시작하고 y로 끝나는 first_name
SELECT employee_id, first_name, last_name FROM employees
WHERE first_name LIKE 'K%y'; -- %는 글자수 모두 허용

-- 3) A로 시작하는 first_name
SELECT employee_id, first_name, last_name FROM employees
WHERE first_name LIKE 'A%';

-- 4) 중간에 E가 들어가는 first_name
SELECT employee_id, first_name, last_name FROM employees
